...
> *Original code by Luxon Server contributors. Modified by Clemtout for better compatibility and performance specifically for Photon network relays within ClemtoutLauncher.*
